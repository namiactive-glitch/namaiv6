...
export const VisionScanner: React.FC<VisionScannerProps> = () => {
  ...
  const [prompt, setPrompt] = useState(() => localStorage.getItem('vision_prompt') || "Trích xuất toàn bộ nội dung văn bản trong hình ảnh này. Giữ nguyên định dạng gốc.");
  const [result, setResult] = useState<string>(() => localStorage.getItem('vision_result') || "");
  ...
  React.useEffect(() => {
    try {
      ...
      localStorage.setItem('vision_result', result);
    } catch (e) {
      console.warn("Error saving VisionScanner state to localStorage:", e);
    }
  }, [prompt, result]);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 py-6">
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-xl shadow-md overflow-hidden border border-orange-100">
            ...
            <div className="bg-orange-600 p-4">
              <h1 className="text-xl flex items-center gap-2 text-white uppercase font-display">
            ...
            <div className="p-6">
              ...
              {/* Upload Area */}
              <div className="mb-6">
                <label className="text-sm text-slate-700 mb-2 block font-display">Hình ảnh cần xử lý</label>
                <div 
              ...
              <div className="space-y-4">
                <label className="text-sm text-slate-700 block font-display">Bạn muốn làm gì?</label>
                ...
                <motion.button
                  ...
                  className={`w-full py-3 rounded-lg flex items-center justify-center gap-2 text-white transition-all shadow-lg font-display
                    ${loading || !image 
        ...
        <div className="flex flex-col h-full min-h-[500px] bg-white rounded-xl shadow-md border border-orange-100 overflow-hidden">
          ...
          <div className="bg-orange-600 p-4 border-b border-orange-200 flex justify-between items-center">
            <h2 className="text-lg text-white flex items-center gap-2 uppercase font-display">
